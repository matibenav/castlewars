...
public class GUI_GameWin extends GUI_Frame {
  ...
  // game panel elements
    ...
    // si le toca a ese jugador, tiene borde negro, sino borde blanco
      ...
      if (Game.getInstance().getPlayers().get(i) == Game.getInstance().getActivePlayer()) {
  ...
  // action listeners de los botones
    ...
    public void actionPerformed(ActionEvent arg0) 
      {
      Game.getInstance().getActivePlayer().takeDamage(1500, false);
      }
    });
